...
type ServerConfig struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Network       []net.Network          `protobuf:"varint,1,rep,packed,name=network,proto3,enum=v2ray.core.common.net.Network" json:"network,omitempty"`
...
func (x *ServerConfig) GetLevel() uint32 {
	if x != nil {
		return x.Level
	}
	return 0
...
const file_proxy_shadowsocks2022_config_proto_rawDesc = "" +
	"\n" +
	"\"proxy/shadowsocks2022/config.proto\x12 v2ray.core.proxy.shadowsocks2022\x1a\x18common/net/address.proto\x1a common/protoext/extensions.proto\x1a\x18common/net/network.proto\"\xc2\x01\n" +
	...
	"\boutbound\x12\x0fshadowsocks2022\x90\xff)\x01\"\xc2\x01\n" +
	"\fServerConfig\x128\n" +
	"\anetwork\x18\x01 \x03(\x0e2\x1e.v2ray.core.common.net.NetworkR\anetwork\x12\x16\n" +
	"\x06method\x18\x02 \x01(\tR\x06method\x12\x10\n" +
	"\x03key\x18\x03 \x01(\tR\x03key\x12\x14\n" +
	"\x05email\x18\x04 \x01(\tR\x05email\x12\x14\n" +
	"\x05level\x18\x05 \x01(\rR\x05level:\"\x82\xb5\x18\x1e\n" +
	"\ainbound\x12\x0fshadowsocks2022\x90\xff)\x01B\x81\x01\n" +
